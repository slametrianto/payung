...
select article.id_article,article.title,article.description,article.date_post,
                ...
                order by article.date_post desc limit ' . $start . ', ' . $limit;
    ...
    function Get_show_article(){   
        return $this->db->query("select * from article order by id_article desc");
    }
