...
<form action="<?php echo base_url(); ?>backend/khotbah/cek" method="post">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-info" id="demo">
                            <div class="panel-heading">
                                ...
                                <div class="panel-toolbar text-right">
                                    <div class="btn-group">
                                   <a type="button" class="btn btn-sm btn-success" data-toggle="tooltip" data-placement="left" title="Add data?" href="<?php echo base_url('backend/khotbah');?>"><i class="icon ico-pencil"></i> Add Data ?</a>
                                </div>
                            </div>
                            <div class="table-responsive panel-collapse pull out">
                               <div class="col-md-4">
                                  <select class="form-control mt4" name="action">
                                    ...
                                    <input type="submit" id="selected" name="selected" class="btn btn-s-md btn-info" formaction="<?php echo base_url(); ?>backend/khotbah/delete_multiple" value="ACTION"><p align="right"></p>
          ...
          ;
                  ...
                  <table class="table table-striped table-bordered table-hover" id="row-detail">
                      ...
                      <tr>
                        ...
                        <th class="th-sortable" data-toggle="class" style="width:10%">No
                          <span class="th-sort">
                           ...
                           <th class="th-sortable" data-toggle="class"  style="width:30%">Nas<span class="th-sort">
                          </span></th>
                          <th class="th-sortable" data-toggle="class"  style="width:30%">Judul<span class="th-sort">
                          </span></th>
                            <th class="th-sortable" data-toggle="class"  style="width:30%">Author<span class="th-sort">
                          </span></th>
                            <th class="th-sortable" data-toggle="class"  style="width:30%">Ringkasan<span class="th-sort">
                          </span></th>
                    ...
                    if(empty($khotbah))
                     ...
                     <tr>
                  <th>
               <input type="checkbox" name="selected[]" id="selected-<?php echo $selected; ?>" class="selected" value="<?php echo $khotbah[$i]["id_khotbah"]; ?>" data-toggle="checkall" data-target="#table1">  
                   <th  style="width:10%"><?php echo ($page+$i+1); ?></th>
                       <th  style="width:30%"><?php echo $khotbah[$i]["nas"]; ?></th>
                       <th  style="width:30%"><?php echo word_limiter($khotbah[$i]["judul"],5); ?></th>
                       <th  style="width:30%"><?php echo $khotbah[$i]["author"]; ?></th>
                       <th  style="width:30%"><?php echo word_limiter($khotbah[$i]["ringkasan"], 10); ?></th>
                       <th  style="width:30%"><?php if($khotbah[$i]["status"] == 1){
                        echo "Publish";
                        }else{
                          echo "Draft";
                        } ?></th>
                          <th  style="width:30%"><img src="<?php echo base_url();?>assets/foto/<?php echo $khotbah[$i]["foto"];?>" width="60" height="60" onError="this.onerror=null;this.src='<?php echo base_url();?>assets/foto/foto.jpg';" width="60" height="60" /></th>
                       <th  style="width:30%">   <a type="button" class="btn btn-sm btn-warning" data-toggle="tooltip" data-placement="left" title="Update data?" href="<?php echo base_url('backend/khotbah/edit_khotbah');?>/<?php echo $khotbah[$i]["id_khotbah"] ?>">Update</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <a type="button" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="right" title="Delete Data?" href="<?php echo base_url('backend/khotbah/delete');?>/<?php echo $khotbah[$i]["id_khotbah"] ?>"onClick="return confirm('Anda Yakin Akan Menghapus Data Ini?');">Delete</a></th>
                   </tr> 
                   <?php
                    $selected++;
                       $selected = $selected++;
