...
<body> 
<div class="row">    
  <?php foreach ($single_catalog as $single_catalog) ?>             
      <form data-validate="parsley" action="<?php echo site_url('backend/catalog/update_catalog');?>/<?php echo $single_catalog["id_catalog"]; ?>" method="post" enctype="multipart/form-data">
              <div class="col-md-12">
                  <div class="panel panel-info" id="demo">
                      <div class="panel-heading">
                          <h3 class="panel-title"><span class="panel-icon mr5"><i class="ico-table22"></i></span> Category Description</h3>
                              <div class="panel-toolbar text-right">
                                        ...
                                        <div class="btn-group">
                                         <div class="col-sm-6">
                                          <div class="form-group ">
                                            <label>Category</label><input type="hidden" name="id_catalog" value="<?php echo $single_catalog["id_catalog"]; ?>"/>
                                         ...
                                         <div class="col-sm-6">
                                           <div class="form-group">
                                          <label>Title</label>
                                          <input type="text" class="form-control" data-required="true" name="title" value="<?php echo $single_catalog["title"]; ?>"/>
                                      ...
                                      <label>Foto</label>
                                         ...
                                         <?php if($single_catalog["foto"] != null){
                                          echo $single_catalog["foto"];
                                          echo "&nbsp;&nbsp;<img height='70' width='70' src='".base_url('assets/foto/'.$single_catalog['foto'])."' > "; 
                                          ?><?php } elseif($single_catalog["foto"] == null){
                                          echo "Foto Belum Diupload";
                                          echo "&nbsp;&nbsp;<img height='70' width='70' src='".base_url('assets/foto/foto.jpg')."' > "; 
                                             } ?></div></div> <div class="col-sm-12">
                                       <div class="form-group">
                                     <label>Description</label>
                                   <textarea class="ckeditor" rows="10" cols="30"  name="description" value="<?php echo set_value('description'); ?>"><?php echo $single_catalog["description"]; ?></textarea>
                                  <?php echo form_error('description'); ?></div></div>
                              </div>
                                    <div class="col-sm-6"><div class="form-group">
                                        <label>Status</label></br>
                                         <?php if($single_catalog["status"] == 1){
                                          echo "<td><span>  
                                        ...
                                        elseif($single_catalog["status"] == 0)
                                          {
                                          echo "<td><span>  
                        ...
                        </br><p align="right"> <a class="btn btn-info" href="<?php echo base_url(); ?>backend/catalog/cek" class="btn btn-danger">Lihat Daftar</a>&nbsp;&nbsp;&nbsp;&nbsp;
                      </p>
                    </section>
                </form>
            </div>
