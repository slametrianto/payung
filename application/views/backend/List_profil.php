...
<form action="<?php echo base_url(); ?>backend/profil/cek" method="post">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-info" id="demo">
                            <div class="panel-heading">
                                <h3 class="panel-title"><span class="panel-icon mr5"><i class="ico-table22"></i></span> PROFIL</h3>
                                ...
                                <div class="panel-toolbar text-right">
                                    <div class="btn-group">
                                   <a type="button" class="btn btn-sm btn-success" data-toggle="tooltip" data-placement="left" title="Add data?" href="<?php echo base_url('backend/profil');?>"><i class="icon ico-pencil"></i> Add Data ?</a>
                                </div>
                            </div>
          ...
          ;
                  ...
                  <table class="table table-striped table-bordered table-hover" id="row-detail">
                    ...
                    if(empty($profil))
                     ...
                     <tr>
                  <th>
               <input type="checkbox" name="selected[]" id="selected-<?php echo $selected; ?>" class="selected" value="<?php echo $profil[$i]["id"]; ?>" data-toggle="checkall" data-target="#table1">  
                   <th  style="width:10%"><?php echo ($page+$i+1); ?></th>
                       <th  style="width:30%"><?php echo word_limiter($profil[$i]["title"],5); ?></th>
                       <th  style="width:30%"><?php echo word_limiter($profil[$i]["description"], 10); ?></th>
                          <th  style="width:30%"><img src="<?php echo base_url();?>assets/foto/<?php echo $profil[$i]["foto"];?>" width="60" height="60" onError="this.onerror=null;this.src='<?php echo base_url();?>assets/foto/foto.jpg';" width="60" height="60" /></th>
                       <th  style="width:30%">   <a type="button" class="btn btn-sm btn-warning" data-toggle="tooltip" data-placement="left" title="Update data?" href="<?php echo base_url('backend/profil/edit_profil');?>/<?php echo $profil[$i]["id"] ?>">Update</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <a type="button" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="right" title="Delete Data?" href="<?php echo base_url('backend/profil/delete');?>/<?php echo $profil[$i]["id"] ?>"onClick="return confirm('Anda Yakin Akan Menghapus Data Ini?');">Delete</a></th>
                   </tr> 
                   <?php
                    $selected++;
                       $selected = $selected++;
