...
<form action="<?php echo base_url(); ?>backend/catalog/cek" method="post">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-info" id="demo">
                            <div class="panel-heading">
                                <h3 class="panel-title"><span class="panel-icon mr5"><i class="ico-table22"></i></span> Category Description</h3>
                                ...
                                <div class="panel-toolbar text-right">
                                    <div class="btn-group">
                                   <a type="button" class="btn btn-sm btn-success" data-toggle="tooltip" data-placement="left" title="Add data?" href="<?php echo base_url('backend/catalog');?>"><i class="icon ico-pencil"></i> Add Data ?</a>
                                </div>
                            </div>
                            <div class="table-responsive panel-collapse pull out">
                               <div class="col-md-4">
                                  <select class="form-control mt4" name="action">
                                    ...
                                    <input type="submit" id="selected" name="selected" class="btn btn-s-md btn-info" formaction="<?php echo base_url(); ?>backend/catalog/delete_multiple" value="ACTION"><p align="right"></p>
          ...
          ;
                  ...
                  <table class="table table-striped table-bordered table-hover" id="row-detail">
                    ...
                    if(empty($catalog))
                     ...
                     <tr>
                  <th>
               <input type="checkbox" name="selected[]" id="selected-<?php echo $selected; ?>" class="selected" value="<?php echo $catalog[$i]["id_catalog"]; ?>" data-toggle="checkall" data-target="#table1">  
                   <th  style="width:10%"><?php echo ($page+$i+1); ?></th>
                       <th  style="width:30%"><?php echo $catalog[$i]["category"]; ?></th>
                       <th  style="width:30%"><?php echo word_limiter($catalog[$i]["title"],5); ?></th>
                       <th  style="width:30%"><?php echo $catalog[$i]["status"]; ?></th>
                       <th  style="width:30%"><?php echo word_limiter($catalog[$i]["description"], 10); ?></th>
                          <th  style="width:30%"><img src="<?php echo base_url();?>assets/foto/<?php echo $catalog[$i]["foto"];?>" width="60" height="60" onError="this.onerror=null;this.src='<?php echo base_url();?>assets/foto/foto.jpg';" width="60" height="60" /></th>
                       <th  style="width:30%">   <a type="button" class="btn btn-sm btn-warning" data-toggle="tooltip" data-placement="left" title="Update data?" href="<?php echo base_url('backend/catalog/edit_catalog');?>/<?php echo $catalog[$i]["id_catalog"] ?>">Update</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <a type="button" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="right" title="Delete Data?" href="<?php echo base_url('backend/catalog/delete');?>/<?php echo $catalog[$i]["id_catalog"] ?>"onClick="return confirm('Anda Yakin Akan Menghapus Data Ini?');">Delete</a></th>
                   </tr> 
                   <?php
                    $selected++;
                       $selected = $selected++;
